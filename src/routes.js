    ...
    return (
        ...
        <BrowserRouter>
         <Switch>
             ...
             <PublicRoute exact path='/auth/activate/:token' restricted={true} component={AccountActivation} />
             <PublicRoute exact path='/forgot-password' restricted={true} component={ForgotPassword} />
